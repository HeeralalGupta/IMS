...
<script src="views/assets/js/plugin/chartist/chartist.min.js"></script>
<script src="views/assets/js/plugin/chartist/plugin/chartist-plugin-tooltip.min.js"></script>
<script src="views/assets/js/plugin/bootstrap-notify/bootstrap-notify.min.js"></script>
<script src="views/assets/js/plugin/bootstrap-toggle/bootstrap-toggle.min.js"></script>
<script src="views/assets/js/plugin/jquery-mapael/jquery.mapael.min.js"></script>
<script src="views/assets/js/plugin/jquery-mapael/maps/world_countries.min.js"></script>
...
<script src="views/assets/js/ready.min.js"></script>
