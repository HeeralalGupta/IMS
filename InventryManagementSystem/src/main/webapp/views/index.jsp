											...
											<tbody class="text-center" id="myTable">
												<c:forEach var="product" items="${products}" varStatus="sno">
													<tr>
														...
														<td class="text-right"><button class="btn btn-danger" id="${product.id}">Delete</button></td>
														<td class="text-left"><button class="btn btn-primary" id="${product.id}">Update</button></td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
